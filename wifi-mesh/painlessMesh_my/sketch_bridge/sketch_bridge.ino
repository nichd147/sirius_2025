...
#define   STATION_SSID     "mi_383B"
#define   STATION_PASSWORD "*****"
#define   STATION_PORT     5555
uint8_t   station_ip[4] =  {192,168,31,149}; // IP of the server
...
void newConnectionCallback(uint32_t nodeId) {
    Serial.printf("bridge: New Connection, nodeId = %u\n", nodeId);
    Serial.printf("bridge: subConnectionJson = %s\n", mesh.subConnectionJson());
}
